...
def train():
  ...
  input_train, output_train, input_dev, output_dev, _, _ = data_utils.prepare_chat_data(
...
def decode():
  with tf.Session() as sess:
    ...
    input_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.in" % FLAGS.input_vocab_size)
    output_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.out" % FLAGS.output_vocab_size)
    in_vocab, _ = data_utils.initialize_vocabulary(input_vocab_path)
    _, rev_out_vocab = data_utils.initialize_vocabulary(output_vocab_path)
